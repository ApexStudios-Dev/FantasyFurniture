...
dependencyResolutionManagement {
    versionCatalogs.create("libs") {
        library("registree", "dev.apexstudios", "registree").version("21.11.3-beta-pr-13") // match version ApexCore is compiled against
        ...
        library("apexcore", "dev.apexstudios", "apexcore").version("21.11.3-beta-pr-68")
