...
dependencyResolutionManagement {
    versionCatalogs.create("libs") {
        library("registree", "dev.apexstudios", "registree").version("21.10.11-beta-pr-14") // match version ApexCore is compiled against
        ...
        library("apexcore", "dev.apexstudios", "apexcore").version("21.10.8-beta-pr-69")
