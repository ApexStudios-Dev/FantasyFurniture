...
dependencyResolutionManagement {
    versionCatalogs.create("libs") {
        library("registree", "dev.apexstudios", "registree").version("21.10.10") // match version ApexCore is compiled against
        ...
        library("apexcore", "dev.apexstudios", "apexcore").version("21.10.9-beta-pr-69")
