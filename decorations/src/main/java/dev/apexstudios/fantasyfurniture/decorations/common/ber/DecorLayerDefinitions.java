...
public interface DecorLayerDefinitions {
    ...
    Identifier WIDOW_BLOOM_TEXTURE = texture("widow_bloom");
    Identifier SKULL_BLOSSOM_SKELETON_TEXTURE = texture("skull_blossom_skeleton");
    Identifier SKULL_BLOSSOM_WITHER_TEXTURE = texture("skull_blossom_wither");
    ...
    private static Identifier texture(String identifier) {
