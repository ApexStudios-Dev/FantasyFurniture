...
public final class SimpleBlockEntityRenderer implements BlockEntityRenderer<BlockEntity, SimpleBlockEntityRenderer.RenderState> {
    ...
    private final Function<BlockEntity, ResourceLocation> textureGetter;

    private SimpleBlockEntityRenderer(EntityModelSet models, ModelLayerLocation modelLocation, Function<BlockEntity, ResourceLocation> textureGetter) {
    ...
    public static BlockEntityRendererProvider<BlockEntity, RenderState> create(ModelLayerLocation modelLocation, Function<BlockEntity, ResourceLocation> textureGetter) {
