...
public final class SimpleBlockEntitySpecialRenderer implements NoDataSpecialModelRenderer {
    ...
    private SimpleBlockEntitySpecialRenderer(SimpleBlockEntityModel model, Identifier texture) {
        this.model = model;
    ...
    public static abstract class Unbaked implements SpecialModelRenderer.Unbaked<Void> {
        ...
        private Unbaked(ModelLayerLocation modelLocation, Identifier texture) {
