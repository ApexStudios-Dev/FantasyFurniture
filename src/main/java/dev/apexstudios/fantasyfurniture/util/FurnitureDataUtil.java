...
public interface FurnitureDataUtil {
    ...
    static void registerBlockTags(DataGenContext context, IntrusiveTagProvider<Block> provider) {
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.PLANKS, block -> tag(provider, block, context.mineableTag, BlockTags.PLANKS));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.BRICKS, block -> tag(provider, block, context.mineableTag, Tags.Blocks.STONES));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.WOOL, block -> tag(provider, block, BlockTags.WOOL));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.CARPET, block -> tag(provider, block, BlockTags.WOOL_CARPETS));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.DRESSER, block -> tag(provider, block, context.mineableTag, ApexTags.Blocks.RENDER_PLACEMENT_WHITELIST, Tags.Blocks.RELOCATION_NOT_SUPPORTED));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.LOCKBOX, block -> tag(provider, block, context.mineableTag));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.DRAWER, block -> tag(provider, block, context.mineableTag));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.CHAIR, block -> tag(provider, block, context.mineableTag, ApexTags.Blocks.RENDER_PLACEMENT_WHITELIST, Tags.Blocks.RELOCATION_NOT_SUPPORTED));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.BOOKSHELF, block -> tag(provider, block, context.mineableTag, ApexTags.Blocks.RENDER_PLACEMENT_WHITELIST, Tags.Blocks.RELOCATION_NOT_SUPPORTED, BlockTags.ENCHANTMENT_POWER_PROVIDER));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.BED_SINGLE, block -> tag(provider, block, context.mineableTag, BlockTags.BEDS, ApexTags.Blocks.RENDER_PLACEMENT_WHITELIST, Tags.Blocks.RELOCATION_NOT_SUPPORTED));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.BED_DOUBLE, block -> tag(provider, block, context.mineableTag, BlockTags.BEDS, ApexTags.Blocks.RENDER_PLACEMENT_WHITELIST, Tags.Blocks.RELOCATION_NOT_SUPPORTED));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.DOOR_SINGLE, block -> tag(provider, block, context.mineableTag, context.doorTag.block(), ApexTags.Blocks.RENDER_PLACEMENT_WHITELIST, Tags.Blocks.RELOCATION_NOT_SUPPORTED));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.DOOR_DOUBLE, block -> tag(provider, block, context.mineableTag, context.doorTag.block(), ApexTags.Blocks.RENDER_PLACEMENT_WHITELIST, Tags.Blocks.RELOCATION_NOT_SUPPORTED));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.DESK_LEFT, block -> tag(provider, block, context.mineableTag, ApexTags.Blocks.RENDER_PLACEMENT_WHITELIST, Tags.Blocks.RELOCATION_NOT_SUPPORTED));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.DESK_RIGHT, block -> tag(provider, block, context.mineableTag, ApexTags.Blocks.RENDER_PLACEMENT_WHITELIST, Tags.Blocks.RELOCATION_NOT_SUPPORTED));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.PAINTING_WIDE, block -> tag(provider, block, context.mineableTag, ApexTags.Blocks.RENDER_PLACEMENT_WHITELIST, Tags.Blocks.RELOCATION_NOT_SUPPORTED));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.PAINTING_SMALL, block -> tag(provider, block, context.mineableTag));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.OVEN, block -> tag(provider, block, BlockTags.MINEABLE_WITH_PICKAXE, Tags.Blocks.PLAYER_WORKSTATIONS_FURNACES));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.CHEST, block -> tag(provider, block, context.mineableTag, ApexTags.Blocks.RENDER_PLACEMENT_WHITELIST, Tags.Blocks.RELOCATION_NOT_SUPPORTED));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.FLOOR_LIGHT, block -> tag(provider, block, context.mineableTag, ApexTags.Blocks.RENDER_PLACEMENT_WHITELIST, Tags.Blocks.RELOCATION_NOT_SUPPORTED));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.CHANDELIER, block -> tag(provider, block, context.mineableTag));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.SHELF, block -> tag(provider, block, context.mineableTag, ApexTags.Blocks.RENDER_PLACEMENT_WHITELIST));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.SOFA, block -> tag(provider, block, context.mineableTag, ApexTags.Blocks.RENDER_PLACEMENT_WHITELIST));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.COUNTER, block -> tag(provider, block, context.mineableTag, ApexTags.Blocks.RENDER_PLACEMENT_WHITELIST));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.WALL_LIGHT, block -> tag(provider, block, context.mineableTag, ApexTags.Blocks.RENDER_PLACEMENT_WHITELIST));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.BENCH, block -> tag(provider, block, context.mineableTag, ApexTags.Blocks.SEAT_PER_BLOCK, ApexTags.Blocks.RENDER_PLACEMENT_WHITELIST, Tags.Blocks.RELOCATION_NOT_SUPPORTED));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.WARDROBE, block -> tag(provider, block, context.mineableTag, ApexTags.Blocks.RENDER_PLACEMENT_WHITELIST, Tags.Blocks.RELOCATION_NOT_SUPPORTED));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.TABLE, block -> tag(provider, block, context.mineableTag, ApexTags.Blocks.RENDER_PLACEMENT_WHITELIST));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.STAIRS, block -> tag(provider, block, context.mineableTag, context.stairsTag));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.SLAB, block -> tag(provider, block, context.mineableTag, context.slabTag.block()));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.FENCE, block -> tag(provider, block, context.mineableTag, context.fenceTag.block()));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.FENCE_GATE, block -> tag(provider, block, context.mineableTag, BlockTags.FENCE_GATES));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.TRAPDOOR, block -> tag(provider, block, context.mineableTag, context.trapdoorTag.block()));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.PRESSURE_PLATE, block -> tag(provider, block, context.mineableTag, context.pressurePlateTag.block()));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.BUTTON, block -> tag(provider, block, context.mineableTag, context.buttonTag.block()));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.HANGING_SIGN, block -> tag(provider, block, context.mineableTag, BlockTags.CEILING_HANGING_SIGNS));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.WALL_HANGING_SIGN, block -> tag(provider, block, context.mineableTag, BlockTags.WALL_HANGING_SIGNS));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.SIGN, block -> tag(provider, block, context.mineableTag, BlockTags.STANDING_SIGNS));
        context.block(DataType.BLOCK_TAG, FurnitureUtil.Names.WALL_SIGN, block -> tag(provider, block, context.mineableTag, BlockTags.WALL_SIGNS));
    }
