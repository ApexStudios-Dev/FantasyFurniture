...
interface FurnitureSetDataGen {
    ...
    static void models(ProviderListenerContext context, ModelProvider provider, FurnitureSet furnitureSet) {
        ...
        blockModels.blockStateOutput.accept(BlockModelGenerators.createSimpleBlock(furnitureSet.block(BlockType.CHAIR).value(), ModelLocationUtils.getModelLocation(furnitureSet.block(BlockType.CHAIR).value())));
        ...
        blockModels.blockStateOutput.accept(BlockModelGenerators.createSimpleBlock(furnitureSet.block(BlockType.LOCKBOX).value(), ModelLocationUtils.getModelLocation(furnitureSet.block(BlockType.LOCKBOX).value())));
