...
public sealed interface BlockType<TBlock extends Block, TItem extends Item> permits BlockType.Impl {
    ...
    BlockType<FurnitureBlock, BlockItem> BED_SINGLE = new Impl<>("bed_single", BlockBehaviour.Properties::of, FurnitureBlock::new, BlockItem::new, null, null);
    BlockType<FurnitureBlock, BlockItem> BOOKSHELF = new Impl<>("bookshelf", BlockBehaviour.Properties::of, FurnitureBlock::new, BlockItem::new, null, null);
    BlockType<FurnitureBlock, BlockItem> CHAIR = new Impl<>("chair", BlockBehaviour.Properties::of, FurnitureBlock::new, BlockItem::new, null, null);
    ...
    BlockType<FurnitureBlock, BlockItem> DRAWER = new Impl<>("drawer", BlockBehaviour.Properties::of, FurnitureBlock::new, BlockItem::new, null, null);
    ...
    BlockType<FurnitureBlock, BlockItem> LOCKBOX = new Impl<>("lockbox", BlockBehaviour.Properties::of, FurnitureBlock::new, BlockItem::new, null, null);
    ...
    BlockType<FurnitureBlock, BlockItem> PAINTING_WIDE = new Impl<>("painting_wide", BlockBehaviour.Properties::of, FurnitureBlock::new, BlockItem::new, null, null);
