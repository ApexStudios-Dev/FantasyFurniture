...
public class FurnitureItemTagsProvider extends ItemTagsProvider {
    ...
    protected void addFurnitureTags() {
        ...
        furniture.item(DataGenType.ITEM_TAG, FurnitureUtil.Names.STAIRS, item -> tag(item, ItemTags.WOODEN_STAIRS));
        ...
        furniture.item(DataGenType.ITEM_TAG, FurnitureUtil.Names.FENCE_GATE, item -> tag(item, ItemTags.FENCE_GATES));
