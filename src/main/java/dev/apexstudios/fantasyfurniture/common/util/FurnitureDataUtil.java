...
public interface FurnitureDataUtil {
    ...
    final class DataGenContext {
        ...
        public void registerBlockTags(BlockTagProvider provider) {
            ...
            block(DataType.BLOCK_TAG, FurnitureUtil.Names.DRESSER, block -> tag(provider, block, Tags.Blocks.RELOCATION_NOT_SUPPORTED));
            ...
            block(DataType.BLOCK_TAG, FurnitureUtil.Names.CHAIR, block -> tag(provider, block, Tags.Blocks.RELOCATION_NOT_SUPPORTED));
            block(DataType.BLOCK_TAG, FurnitureUtil.Names.BOOKSHELF, block -> tag(provider, block, Tags.Blocks.RELOCATION_NOT_SUPPORTED, BlockTags.ENCHANTMENT_POWER_PROVIDER));
            block(DataType.BLOCK_TAG, FurnitureUtil.Names.BED_SINGLE, block -> tag(provider, block, BlockTags.BEDS, Tags.Blocks.RELOCATION_NOT_SUPPORTED));
            block(DataType.BLOCK_TAG, FurnitureUtil.Names.BED_DOUBLE, block -> tag(provider, block, BlockTags.BEDS, Tags.Blocks.RELOCATION_NOT_SUPPORTED));
            block(DataType.BLOCK_TAG, FurnitureUtil.Names.DOOR_SINGLE, block -> tag(provider, block, doorTag.block(), Tags.Blocks.RELOCATION_NOT_SUPPORTED));
            block(DataType.BLOCK_TAG, FurnitureUtil.Names.DOOR_DOUBLE, block -> tag(provider, block, doorTag.block(), Tags.Blocks.RELOCATION_NOT_SUPPORTED));
            block(DataType.BLOCK_TAG, FurnitureUtil.Names.DESK_LEFT, block -> tag(provider, block, Tags.Blocks.RELOCATION_NOT_SUPPORTED));
            block(DataType.BLOCK_TAG, FurnitureUtil.Names.DESK_RIGHT, block -> tag(provider, block, Tags.Blocks.RELOCATION_NOT_SUPPORTED));
            block(DataType.BLOCK_TAG, FurnitureUtil.Names.PAINTING_WIDE, block -> tag(provider, block, Tags.Blocks.RELOCATION_NOT_SUPPORTED));
            ...
            block(DataType.BLOCK_TAG, FurnitureUtil.Names.CHEST, block -> tag(provider, block, Tags.Blocks.RELOCATION_NOT_SUPPORTED));
            block(DataType.BLOCK_TAG, FurnitureUtil.Names.FLOOR_LIGHT, block -> tag(provider, block, Tags.Blocks.RELOCATION_NOT_SUPPORTED));
            block(DataType.BLOCK_TAG, FurnitureUtil.Names.CHANDELIER, block -> tag(provider, block));
            block(DataType.BLOCK_TAG, FurnitureUtil.Names.SHELF, block -> tag(provider, block));
            block(DataType.BLOCK_TAG, FurnitureUtil.Names.SOFA, block -> tag(provider, block));
            block(DataType.BLOCK_TAG, FurnitureUtil.Names.COUNTER, block -> tag(provider, block));
            block(DataType.BLOCK_TAG, FurnitureUtil.Names.WALL_LIGHT, block -> tag(provider, block));
            block(DataType.BLOCK_TAG, FurnitureUtil.Names.BENCH, block -> tag(provider, block, ApexTags.Blocks.SEAT_PER_BLOCK, Tags.Blocks.RELOCATION_NOT_SUPPORTED));
            block(DataType.BLOCK_TAG, FurnitureUtil.Names.WARDROBE, block -> tag(provider, block, Tags.Blocks.RELOCATION_NOT_SUPPORTED));
            block(DataType.BLOCK_TAG, FurnitureUtil.Names.TABLE, block -> tag(provider, block));
